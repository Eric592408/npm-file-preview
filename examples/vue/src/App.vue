      ...
      <div class="logo-section">
        ...
        <div class="title-section">
          <h1 class="cyber-title">
            <span class="title-text">VUE 3 DEMO</span>
            <span class="title-glitch" aria-hidden="true">VUE 3 DEMO</span>
          </h1>
          <p class="cyber-subtitle">// Universal File Preview - Vue 3 Integration</p>
        </div>
      </div>
      <div class="status-indicator">
        <span class="status-dot"></span>
        <span class="status-text">VUE MODE</span>
      </div>
    </header>
